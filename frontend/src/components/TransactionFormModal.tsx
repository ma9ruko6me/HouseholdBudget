...
export function TransactionFormModal({
  ...
  const handleRemoveExpenseCategory = async (id: number) => {
  ...
  const handleRemoveIncomeCategory = async (id: number) => {
    if (!window.confirm('このカテゴリを削除しますか？')) return;
    try {
                    ...
                    {!selected && (
                      <button
                        ...
                        onClick={(event) => {
                          ...
                          if (entryKind === 'expense') {
                            void handleRemoveExpenseCategory(category.id);
                          } else {
                            void handleRemoveIncomeCategory(category.id);
                          }
                        }}
                      >
                        ×
